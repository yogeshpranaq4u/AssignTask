...
public class NumberPickerActivity extends ModalDialog {
    protected NumberWheelLayout wheelLayout;
    private OnNumberPickedListener onNumberPickedListener;

    public NumberPickerActivity(@NonNull Activity activity) {
        super(activity);
    }

    public NumberPickerActivity(@NonNull Activity activity, @StyleRes int themeResId) {
